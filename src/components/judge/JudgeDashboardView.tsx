...
export const JudgeDashboardView: React.FC<JudgeDashboardViewProps> = ({
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* Projects Table */}
      <div className="glass-panel rounded-3xl p-4 sm:p-6 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
          <div>
            <h2 className="font-heading text-base sm:text-lg font-bold text-slate-900 dark:text-white flex items-center space-x-2">
