...
export const RegisterForm: React.FC<RegisterFormProps> = ({ onSwitchToLogin }) => {
  ...
  return (
    <div className="mx-auto max-w-md w-full">
      <div className="glass-panel rounded-2xl p-6 sm:p-8 shadow-2xl border border-slate-700/60 bg-slate-900">
        ...
        {isSubmitted ? (
          ...
          <div className="text-center py-4 space-y-4 animate-in fade-in zoom-in duration-200">
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 shadow-lg shadow-emerald-500/20">
              <CheckCircle className="h-8 w-8 text-emerald-400" />
            </div>
            
            <div>
              <h2 className="font-heading text-2xl font-bold text-white">Registration Submitted!</h2>
              <p className="text-xs text-slate-400 mt-1">Your judge account has been successfully created.</p>
            </div>

            <div className="rounded-xl bg-amber-500/10 border border-amber-500/30 p-4 text-xs text-left space-y-1.5">
              ...
              <p className="text-amber-200/90 leading-relaxed text-[11px]">
                Registration for <strong className="text-white">{email}</strong> is now awaiting review. You will be able to log in to the Judge Portal once an Administrator approves your account.
              </p>
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full rounded-xl bg-indigo-600 hover:bg-indigo-700 py-3 text-sm font-semibold text-white shadow-lg flex items-center justify-center space-x-2 transition-all"
              >
